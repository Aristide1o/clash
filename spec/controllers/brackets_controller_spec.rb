  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bracket" do
        ...
        Bracket.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => bracket.to_param, :bracket => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bracket as @bracket" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bracket.any_instance.stub(:save).and_return(false)
        put :update, {:id => bracket.to_param, :bracket => {}}, valid_session
        assigns(:bracket).should eq(bracket)
      end
